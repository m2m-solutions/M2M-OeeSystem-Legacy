<%@ Control Language="C#" AutoEventWireup="true" Inherits="M2M.DataCenter.WebUI.Admin.AdvancedTemplates.BooleanAttributeControl" Codebehind="BooleanAttributeControlCS.ascx.cs" %>

...
namespace M2M.DataCenter.WebUI.Admin.AdvancedTemplates
{
	...
	public partial class AdvancedForm : UserControl
	{
		...
		public object ShiftId
		{
			get
			{
				return ResShift.Value;
			}

			set
			{
				ResShift.Value = value;
			}
		}

		[Bindable(BindableSupport.Yes, BindingDirection.TwoWay)]
		public object DeviceUnitId
		{
			get
			{
				return ResDeviceUnit.Value;
			}

			set
			{
                ResDeviceUnit.Value = value;
                SubTitle.Text = ((Resource)value).Text;

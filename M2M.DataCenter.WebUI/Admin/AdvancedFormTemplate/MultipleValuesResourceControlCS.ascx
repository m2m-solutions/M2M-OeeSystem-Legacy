<%@ Control Language="C#" AutoEventWireup="true" Inherits="M2M.DataCenter.WebUI.Admin.AdvancedTemplates.MultipleValuesResourceControl" Codebehind="MultipleValuesResourceControlCS.ascx.cs" %>

...
{
    public partial class MultipleValuesResourceControl : UserControl
    {
        ...
        {
            ResourceType resType = Owner.ResourceTypes.FindByName(Type);
            foreach (Resource res in Appointment.Resources.GetResourcesByType(resType.Name))
            {

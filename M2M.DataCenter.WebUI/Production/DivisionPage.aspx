<%@ Page Title="" Language="C#" MasterPageFile="~/M2MDataCenter.Master" AutoEventWireup="true" CodeBehind="DivisionPage.aspx.cs" Inherits="M2M.DataCenter.WebUI.Production.DivisionPage" %>
<%@ Register Src="MachineListControl.ascx" TagName="MachineListControl" TagPrefix="uc1" %>
<%@ Register Src="OEEControl.ascx" TagName="OEEControl" TagPrefix="uc2" %>

<%@ Register src="FilterControl.ascx" tagname="FilterControl" tagprefix="uc3" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<div class="divFilter">
		<uc3:FilterControl ID="ucFilterControl" runat="server" ArticleMethodName="GetDivisionArticles" InformationVisible="False" AutoVisible="False" ProductionSwitchVisible="False"  />
	</div>
	<div class="divider"></div>
	<div class="divOEE">
...
<FilterMenu EnableImageSprites="False"></FilterMenu>
	...
	<div class="divider"></div>
	<div class="divEvents">
		<uc1:MachineListControl ID="ucMachineListControl" runat="server" />
	</div>
	<div class="divider"></div>
</div>
											</div>

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MachineFilterControl.ascx.cs" Inherits="M2M.DataCenter.WebUI.Production.MachineFilterControl" %>
...
<script type="text/javascript">
    ...
    function onRefreshClick() {
        ...
        var valid = (check.checked || combo.get_text() != '<%= GetResourceString("ShowNoAlerts") %>');
        if (valid) {
            return true;
        }
        else
        {
            radalert('<%= GetResourceString("Warning.NoEventTypesSelected") %>', null, null, '<%= GetResourceString("Warning.Title") %>');
            return false;
        } 
									...
									<div class="topright">
										<div class="content">
											<div class="filterView">
												...
												<div class="item">
													<div class="label">
														<asp:CheckBox ID="checkExcludeNoProduction" runat="server" Checked="True" Text="<%$ DataCenter:IgnoreNoProduction %>" />
													</div>
												</div>
												<div class="item">
													 <div class="label">
														 <asp:CheckBox ID="checkInfo" runat="server" Checked="True" Text="<%$ DataCenter:Information %>" />
													</div>

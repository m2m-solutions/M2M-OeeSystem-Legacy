...
{
    public partial class FilterNpbWeekly : ReportFilterBase
	{
		#region Members
        ...
        {
            Modules.DataTextField = "DisplayName";
            Modules.DataValueField = "GroupingId";
            Modules.DataSource = M2MDataCenter.GetGroupings(GroupingType.Module);
            Modules.DataBind();

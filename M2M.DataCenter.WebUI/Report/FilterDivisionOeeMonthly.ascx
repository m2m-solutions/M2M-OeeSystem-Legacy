<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FilterDivisionOeeMonthly.ascx.cs" Inherits="M2M.DataCenter.WebUI.Report.FilterDivisionOeeMonth" %>
<div class="filterView" style="height: 40px;" >
	...
	<div class="last" style="top: 15px; left: 500px">
		<div class="button">

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FilterMachineStoppageMonthly.ascx.cs" Inherits="M2M.DataCenter.WebUI.Report.FilterMachineStoppageMonthly" %>
...
<div class="filterView" style="height: 40px;" >
    ...
    <div class="item" style="top: 0px; left: 560px">
		<div class="label">
			<asp:Label ID="Label3" runat="server" Text="<%$ DataCenter:Month#: %>"></asp:Label>
		</div>
			<div class="input">
    ...
    <div class="item" style="top: 0px; left: 675px">
		<div class="label">
    ...
    <div class="item" style="top: 0px; left: 830px">
		<div class="label">

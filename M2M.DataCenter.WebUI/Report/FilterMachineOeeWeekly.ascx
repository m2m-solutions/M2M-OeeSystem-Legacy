<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FilterMachineOeeWeekly.ascx.cs" Inherits="M2M.DataCenter.WebUI.Report.FilterMachineOeeWeekly" %>
...
<div class="filterView" style="height: 40px;" >
    ...
    <div class="last" style="top: 15px; left: 635px">
		<div class="button">

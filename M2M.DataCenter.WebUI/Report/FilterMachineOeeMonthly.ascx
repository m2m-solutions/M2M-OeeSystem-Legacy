<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FilterMachineOeeMonthly.ascx.cs" Inherits="M2M.DataCenter.WebUI.Report.FilterMachineOeeMonthly" %>
...
<div class="filterView" style="height: 40px;" >
    ...
    <div class="last" style="top: 15px; left: 675px">
		<div class="button">

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FilterDivisionOeeWeekly.ascx.cs" Inherits="M2M.DataCenter.WebUI.Report.FilterDivisionOeeWeekly" %>
<div class="filterView" style="height: 40px;" >
    ...
    <div class="item" style="top: 0px; left: 175px">
		<div class="label">
			...
			<div class="input">
			<telerik:RadComboBox ID="ProductionShifts" Width="120px" Skin="Default" AutoPostBack="False" runat="server">
					<CollapseAnimation Duration="200" Type="OutQuint" />
				</telerik:RadComboBox>
		</div>
	</div>
	...
	<div class="last" style="top: 15px; left: 450px">
		<div class="button">

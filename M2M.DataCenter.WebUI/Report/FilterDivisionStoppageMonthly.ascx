<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FilterDivisionStoppageMonthly.ascx.cs" Inherits="M2M.DataCenter.WebUI.Report.FilterDivisionStoppageMonthly" %>
...
<div class="filterView" style="height: 40px;" >
    ...
    <div class="item" style="top: 0px; left: 385px">
		<div class="label">
			<asp:Label ID="Label2" runat="server" Text="<%$ DataCenter:Month#: %>"></asp:Label>
		</div>
			<div class="input">
    ...
    <div class="item" style="top: 0px; left: 500px">
		<div class="label">
	...
	<div class="last" style="top: 15px; left: 770px">
		<div class="button">

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FilterPlantProductionWeekly.ascx.cs" Inherits="M2M.DataCenter.WebUI.Report.FilterPlantProductionWeekly" %>
<div class="filterView" style="height: 40px;" >
	...
	<div class="last" style="top: 15px; left: 310px">
		<div class="button">

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FilterStoppageAnalyzeMonthly.ascx.cs" Inherits="M2M.DataCenter.WebUI.Report.FilterStoppageAnalyzeMonthly" %>
...
<div class="filterView" style="height: 40px;" >
    ...
    <div class="item" style="top: 0px; left: 490px">
		<div class="label">
    ...
    <div class="item" style="top: 0px; left: 645px">
		<div class="label">
    ...
    <div class="item" style="top: 0px; left: 860px">
		<div class="label">
    ...
    <div class="last" style="top: 15px; left: 1075px">
		<div class="button">

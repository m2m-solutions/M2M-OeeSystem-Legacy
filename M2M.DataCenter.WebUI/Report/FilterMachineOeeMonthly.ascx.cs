...
{
    public partial class FilterMachineOeeMonthly : ReportFilterBase
	{
		#region Members
        ...
        public override void BindData()
        {
            ...
            for (int i = DateTime.Today.AddMonths(-1).Year; i >= 2005; i--)
            {
            ...
            Years.DataBind();
            Years.SelectedValue = DateTime.Today.Year.ToString();

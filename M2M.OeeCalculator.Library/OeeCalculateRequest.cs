...
{
	[Serializable()]
	public partial class OeeCalculateRequest : BusinessBase<OeeCalculateRequest>
	{
		...
		public static OeeCalculateRequest NewOeeCalculateRequest()
		{
			return DataPortal.Create<OeeCalculateRequest>();
		}

		internal static OeeCalculateRequest GetOeeCalculateRequest(
		  SafeDataReader dr)
		{
			return new OeeCalculateRequest(dr);
		}

		protected OeeCalculateRequest()
		{
			/* require use of factory methods */
		}

        protected OeeCalculateRequest(SafeDataReader dr)
			: this()
		{
			Fetch(dr);
		}
		...
		protected override void DataPortal_Insert()
		{
            ...
            using (SqlConnection connection = new SqlConnection(Database.SystemConnectionString))
            {
                ...
                {
                    command.CommandText = "INSERT INTO OeeCalculateRequests (" +
                                                "DivisionId," +
                                                "MachineId," +
                                                "StartDate," +
                                                "EndDate" +
		...
		internal void DeleteSelf()
		{
			...
			using (SqlCommand command = connection.CreateCommand())
			{
                command.CommandText = @"DELETE FROM OeeCalculateRequests WHERE " +
										@"Id=@Id";

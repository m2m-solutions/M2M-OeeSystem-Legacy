...
namespace M2M.DataCenter.Reports
{
    ...
    [Description("Default")]
    [DisplayName("19")]
    public partial class ArticleStoppageAnalyzeWeekly : Telerik.Reporting.Report
    {
        #region Properties
        ...
        public ArticleStoppageAnalyzeWeekly()
        {
            /// <summary>
        ...
        {
            #region Page header
            tbHeader.Value = ResourceStrings.GetString("Report.ArticleStoppageAnalyzeWeekly.Header");
            tbSubHeader.Value = ResourceStrings.GetString("#+Report.ArticleStoppageAnalyzeWeekly.SubHeader");
        ...
        public static string GetDocumentName(object machine, object category, object reason, object year, object week)
        {
            string text = reason != null ? reason.ToString() : M2MDataCenter.GetCategoryDisplayName((int)category);

            return String.Format(ResourceStrings.GetString("Report.ArticleStoppageAnalyzeWeekly.DocumentName"), M2MDataCenter.GetMachine(machine.ToString()).DisplayName, text, year, week);
        }

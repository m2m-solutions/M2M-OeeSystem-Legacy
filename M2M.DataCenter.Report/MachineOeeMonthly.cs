...
namespace M2M.DataCenter.Reports
{
    ...
    public partial class MachineOeeMonthly : Telerik.Reporting.Report
    {
        ...
        {
            #region Page header
            textBox25.Value = ResourceStrings.GetString("#+Report.MachineOeeMonthly.SubHeader");
            textBox26.Value = ResourceStrings.GetString("Report.MachineOeeMonthly.Header");
            ...
            textBox4.Value = ResourceStrings.GetString("MachineNotInProduction#:");
            ...
            textBox32.Value = ResourceStrings.GetString("EffectiveProductionTime#:");
        ...
        {
            return String.Format(ResourceStrings.GetString("Report.MachineOeeMonthly.DocumentName"), M2MDataCenter.GetMachine(machine.ToString()).DisplayName, year, month);
        }

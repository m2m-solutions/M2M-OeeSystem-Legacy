...
namespace M2M.DataCenter.Reports
{
    ...
    [Description("Default")]
    [DisplayName("13")]
    public partial class DivisionStoppageWeekly : Telerik.Reporting.Report
    {
        #region Properties
        ...
        {
            #region Page header
            textBox39.Value = ResourceStrings.GetString("#+Report.DivisionStoppageWeekly.SubHeader");
            textBox26.Value = ResourceStrings.GetString("Report.DivisionStoppageWeekly.Header");
            ...
            textBox23.Value = ResourceStrings.GetString("MachineNotConnected#:");
        ...
        {
            return String.Format(ResourceStrings.GetString("Report.DivisionStoppageWeekly.DocumentName"), M2MDataCenter.GetDivision(division.ToString()).DisplayName, year, week);
        }

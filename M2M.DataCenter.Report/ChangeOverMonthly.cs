...
namespace M2M.DataCenter.Reports
{
    ...
    [DisplayName("30")]
    public partial class ChangeOverMonthly : Telerik.Reporting.Report
    {
        #region Properties
        ...
        {
            #region Page header
            tbHeader.Value = ResourceStrings.GetString("Report.ChangeOverMonthly.Header");
            tbSubHeader.Value = ResourceStrings.GetString("#+Report.ChangeOverMonthly.SubHeader");
            ...
            textBox17.Value = ResourceStrings.GetString("Total#:");
            textBox24.Value = ResourceStrings.GetString("Subtotal#:");
            textBox19.Format = String.Format("{0} {1}", "{0:N1}", ResourceStrings.GetString("#-Minutes.Abbr"));
            textBox18.Format = String.Format("{0} {1}", "{0:N1}", ResourceStrings.GetString("#-Minutes.Abbr"));
            textBox22.Format = String.Format("{0} {1}", "{0:N1}", ResourceStrings.GetString("#-Minutes.Abbr"));
            textBox23.Format = String.Format("{0} {1}", "{0:N1}", ResourceStrings.GetString("#-Minutes.Abbr"));
            textBox25.Format = String.Format("{0} {1}", "{0:N1}", ResourceStrings.GetString("#-Minutes.Abbr"));
            #endregion
        ...
        public static string GetDocumentName(object machine, object year, object month)
        {
            return String.Format(ResourceStrings.GetString("Report.ChangeOverMonthly.DocumentName"), M2MDataCenter.GetMachine(machine.ToString()).DisplayName, year, month);
        }

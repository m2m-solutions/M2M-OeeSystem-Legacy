...
namespace M2M.DataCenter.Reports
{
    ...
    public partial class MachineOeeDaily : Telerik.Reporting.Report
    {
        ...
        {
            #region Page header
            tbHeaderLeft.Value = ResourceStrings.GetString("#+Report.MachineOeeDaily.SubHeader");
            tbHeader.Value = ResourceStrings.GetString("Report.MachineOeeDaily.Header");
            ...
            textBox64.Value = ResourceStrings.GetString("ActualDowntime#:");
            textBox63.Format = String.Format("{0} {1}", "{0:N1}", ResourceStrings.GetString("#-Hours.Abbr"));
            textBox61.Value = ResourceStrings.GetString("FlowErrorDowntime#:");
            textBox62.Format = String.Format("{0} {1}", "{0:N1}", ResourceStrings.GetString("#-Hours.Abbr"));
            ...
            #region Articles
            textBox24.Value = ResourceStrings.GetString("Articles");
            ...
            textBox69.Value = ResourceStrings.GetString("AvailabilityLoss.Abbr");
            textBox67.Value = ResourceStrings.GetString("AvailabilityLossBasedOnActualStops.Abbr");
            textBox65.Value = ResourceStrings.GetString("AvailabilityLossBasedOnFlowErrors.Abbr");
            ...
            #region Downtime
            textBox57.Value = ResourceStrings.GetString("Category");
        ...
        public static string GetDocumentName(object machine, object endDate)
        {
            return String.Format(ResourceStrings.GetString("Report.MachineOeeDaily.DocumentName"), M2MDataCenter.GetMachine(machine.ToString()).DisplayName, endDate);
        }
        ...
        private void tableArticles_NeedDataSource(object sender, EventArgs e)
        {
            ...
            table.DataSource = m_AggregatedDataContainer.OeeData.GetArticleData((string)table.Report.Parameters["MachineId"].Value);
        }

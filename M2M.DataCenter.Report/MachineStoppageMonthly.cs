...
namespace M2M.DataCenter.Reports
{
    ...
    public partial class MachineStoppageMonthly : Telerik.Reporting.Report
    {
        ...
        {
            #region Page header
            textBox25.Value = ResourceStrings.GetString("#+Report.MachineStoppageMonthly.SubHeader");
            textBox26.Value = ResourceStrings.GetString("Report.MachineStoppageMonthly.Header");
        ...
        {
            return String.Format(ResourceStrings.GetString("Report.MachineStoppageMonthly.DocumentName"), M2MDataCenter.GetMachine(machine.ToString()).DisplayName, year, month);
        }

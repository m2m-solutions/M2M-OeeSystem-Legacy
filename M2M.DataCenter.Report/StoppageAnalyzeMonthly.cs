...
namespace M2M.DataCenter.Reports
{
    ...
    [Description("Default")]
    [DisplayName("18")]
    public partial class StoppageAnalyzeMonthly : Telerik.Reporting.Report
    {
        #region Properties
        ...
        {
            #region Page header
            tbHeader.Value = ResourceStrings.GetString("Report.StoppageAnalyzeMonthly.Header");
            tbSubHeader.Value = ResourceStrings.GetString("#+Report.StoppageAnalyzeMonthly.SubHeader");
        ...
        public static string GetDocumentName(object division, object category, object reason, object year, object month)
        {
            string text = reason != null ? reason.ToString() : M2MDataCenter.GetCategoryDisplayName((int)category);
            return String.Format(ResourceStrings.GetString("Report.StoppageAnalyzeMonthly.DocumentName"), M2MDataCenter.GetDivision(division.ToString()).DisplayName, text, year, month);
        }

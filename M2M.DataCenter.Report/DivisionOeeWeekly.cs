...
namespace M2M.DataCenter.Reports
{
    ...
    [Description("Default")]
    [DisplayName("12")]
    public partial class DivisionOeeWeekly : Telerik.Reporting.Report
    {
        #region Properties
        ...
        {
            #region Page header
            textBox25.Value = ResourceStrings.GetString("#+Report.DivisionOeeWeekly.SubHeader");
            textBox26.Value = ResourceStrings.GetString("Report.DivisionOeeWeekly.Header");
        ...
        {
            return String.Format(ResourceStrings.GetString("Report.DivisionOeeWeekly.DocumentName"), M2MDataCenter.GetDivision(division.ToString()).DisplayName, year, week);
        }

...
{     
    // Change these keys     
    private readonly byte[] Key = { 55, 117, 19, 131, 24, 122, 85, 222, 114, 144, 66, 162, 37, 112, 222, 209, 41, 24, 76, 144, 173, 252, 112, 23, 24, 26, 227, 18, 131, 236, 153, 99 };
    private readonly byte[] Vector = { 146, 64, 191, 191, 39, 3, 113, 144, 211, 45, 27, 112, 79, 132, 14, 52 };
